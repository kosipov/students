      ...
      subjects: [
        {
          ...
          name: 'Веб-разработка',
          tasks: [
            { id: 100, name: 'Темы курсовых', comment: '', href: 'https://example.com/1', isDocument: false, categories: ['Курсовые'], locked: false },
            { id: 101, name: 'Методичка', comment: '', href: 'https://example.com/2', isDocument: false, categories: ['Методички', 'Курсовые'], locked: false },
            { id: 102, name: 'Лабораторная', comment: '', href: 'https://example.com/3', isDocument: false, categories: [], locked: false },
          ],
        },
        { id: 20, name: 'Без категорий', tasks: [{ id: 200, name: 'Задание', comment: '', href: '', isDocument: false, categories: [], locked: false }] },
      ],
    },
  ],
}
